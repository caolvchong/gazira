...
define(function(require, exports, module) {
    ...
    var YearPanel = Widget.extend({
        ...
        show: function() {
            ...
            var years = this.$('[data-val]');

            if(years.length === 0 || (year < years.eq(1).attr('data-val') || year > years.eq(years.length - 2).attr('data-val'))) {
                var n = this.get('n');
                var m = this.get('m');
                ...
                this.$('.year-curr').removeClass('year-curr');
                this.$('[data-val="' + year + '"]').addClass('year-curr');
            }
            this.element.show();
            return this;
        }
