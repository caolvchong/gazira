/**
 * 下面代码只是将Highcharts转化为CMD模块，有修改的行在该行附近都有中文注释
 * 所有使用版权请依据Highcharts的 License: www.highcharts.com/license
 */
define(function(require, exports, module) {
    ...
    (function() {
        ...
        // some variables
            ...
            globalAnimation, pathAnim, timeUnits, noop = function() {}, charts = [], PRODUCT = 'Highcharts', VERSION = '3.0.5',
        ...
        // constants for attributes
            LINEAR_GRADIENT = 'linearGradient', STOPS = 'stops', STROKE_WIDTH = 'stroke-width',
        ...
        var Highcharts = {};
        module.exports = Highcharts; // 修改为exports方式
        ...
        function normalizeTimeTickInterval(tickInterval, unitsOption) {
            ...
            // get the count
            count = normalizeTickInterval(tickInterval / interval, multiples, unit[0] === YEAR ? getMagnitude(tickInterval / interval) : 1 // #1913
            );
        ...
        function getTimeTicks(normalizedInterval, min, max, startOfWeek) {
            ...
            if(defined(min)) { // #1300
                ...
                i = 1;
                minYear = minDate[getFullYear]();
                var time = minDate.getTime(), minMonth = minDate[getMonth](), minDateDate = minDate[getDate](), timezoneOffset = useUTC ? 0 : (24 * 3600 * 1000 + minDate.getTimezoneOffset() * 60 * 1000) % (24 * 3600 * 1000); // #950
        ...
        var HighchartsAdapter; // 增加局部变量
        (function($) {
            /**
             * The default HighchartsAdapter for jQuery
             */
            // win.HighchartsAdapter = win.HighchartsAdapter || ($ && {
            HighchartsAdapter = ($ && { // 无须adapter方式了
                /**
        ...
        // check for a custom HighchartsAdapter defined prior to this file // 修改为下面一行
        var globalAdapter = HighchartsAdapter, adapter = globalAdapter || {};
        ...
        SVGElement.prototype = {
            ...
            css: function(styles) {
                ...
                var elemWrapper = this, elem = elemWrapper.element, textWidth = styles && styles.width && elem.nodeName.toLowerCase() === 'text', n, serializedCss = '', hyphenate = function(a, b) { return '-' + b.toLowerCase(); };
                /*jslint unparam: false*/
        ...
        SVGRenderer.prototype = {
                ...
                each(lines, function(line, lineNo) {
                    ...
                    each(spans, function(span) {
                        if(span !== '' || spans.length === 1) {
                            var attributes = {}, tspan = doc.createElementNS(SVG_NS, 'tspan'), spanStyle; // #390
            ...
            symbols: {
                'circle': function(x, y, w, h) {
                    var cpw = 0.166 * w;
                    return [
                        M, x + w / 2, y, 'C', x + w + cpw, y, x + w + cpw, y + h, x + w / 2, y + h, 'C', x - cpw, y + h, x - cpw, y, x + w / 2, y, 'Z'
                    ];
                },
                ...
                'triangle': function(x, y, w, h) {
                    return [
                        M, x + w / 2, y, L, x + w, y + h, x, y + h, 'Z'
                    ];
                },

                'triangle-down': function(x, y, w, h) {
                    return [
                        M, x, y, L, x + w, y, x + w / 2, y + h, 'Z'
                    ];
                },
                'diamond': function(x, y, w, h) {
                    return [
                        M, x + w / 2, y, L, x + w, y + h / 2, x + w / 2, y + h, x, y + h / 2, 'Z'
                    ];
                },
                'arc': function(x, y, w, h, options) {
                    var start = options.start, radius = options.r || w || h, end = options.end - 0.001, // to prevent cos and sin of start and end from becoming equal on 360 arcs (related: #1561)
                    ...
                    return [
                        M, x + radius * cosStart, y + radius * sinStart, 'A', // arcTo
                        radius, // x radius
                        radius, // y radius
                        0, // slanting
                    ...
                    rect: function(left, top, width, height, options) {
                        ...
                        if(!defined(options) || !options.r) {
                            ...
                            ret = [
                                ...
                                L, right - r, top, 'wa', right - 2 * r, top, right, top + 2 * r, right - r, top, right, top + r,

                                L, right, bottom - r, 'wa', right - 2 * r, bottom - 2 * r, right, bottom, right, bottom - r, right - r, bottom,

                                L, left + r, bottom, 'wa', left, bottom - 2 * r, left + 2 * r, bottom, left + r, bottom, left, bottom - r,

                                L, left, top + r, 'wa', left, top, left + 2 * r, top + 2 * r, left, top + r, left + r, top,
        ...
        Tick.prototype = {
             ...
             */
            addLabel: function() {
                var tick = this, axis = tick.axis, options = axis.options, chart = axis.chart, horiz = axis.horiz, categories = axis.categories, names = axis.series[0] && axis.series[0].names, pos = tick.pos, labelOptions = options.labels, str, tickPositions = axis.tickPositions, width = (horiz && categories && !labelOptions.step && !labelOptions.staggerLines && !labelOptions.rotation && chart.plotWidth / tickPositions.length) || (!horiz && (chart.optionsMarginLeft || chart.chartWidth * 0.33)), // #1580, #1931
                ...
                if(!defined(label)) {
                    ...
                    tick.label = defined(str) && labelOptions.enabled ? chart.renderer.text(str, 0, 0, labelOptions.useHTML).attr(attr)// without position absolute, IE export sometimes is wrong
            ...
            getLabelSides: function() {
                var bBox = this.labelBBox, // assume getLabelSize has run at this point
                    axis = this.axis, options = axis.options, labelOptions = options.labels, width = bBox.width, leftSide = width * { left: 0, center: 0.5, right: 1 }[axis.labelAlign] - labelOptions.x;
        ...
        StackItem.prototype = {
            ...
            render: function(group) {
                var options = this.options, formatOption = options.format, str = formatOption ? format(formatOption, this) : options.formatter.call(this);  // format the text in the label
                ...
                if(this.label) {
                    ...
                    this.label = this.axis.chart.renderer.text(str, 0, 0, options.useHTML)		// dummy positions, actual position updated with setOffset method in columnseries
        ...
        Axis.prototype = {
            ...
            remove: function(redraw) {
                var chart = this.chart, key = this.xOrY + 'Axis'; // xAxis or yAxis
	 ...
	 */
            ...
            getLinePath: function(lineWidth) {
                ...
                return chart.renderer.crispLine([
                    M, horiz ? this.left : lineLeft, horiz ? lineTop : this.top, L, horiz ? chart.chartWidth - this.right : lineLeft, horiz ? lineTop : chart.chartHeight - this.bottom
                ], lineWidth);
            },
        ...
        Tooltip.prototype = {
            ...
            init: function(chart, options) {
                ...
                this.label = chart.renderer.label('', 0, 0, options.shape, null, null, options.useHTML, null, 'tooltip').attr({
                    ...
                    zIndex: 8
                }).css(style).css({ padding: 0 }) // Remove it from VML, the padding is applied as an attribute instead (#1117)
                    .hide().add();
            ...
            getAnchor: function(points, mouseEvent) {
                ...
                if(this.followPointer && mouseEvent) {
                    ...
                    ret = [
                        mouseEvent.chartX - chart.plotLeft, mouseEvent.chartY - plotTop
                    ];
                }
                ...
                if(!ret) {
                    ...
                    ret = [
                        inverted ? chart.plotWidth - plotY : plotX, this.shared && !inverted && points.length > 1 && mouseEvent ? mouseEvent.chartY - plotTop : // place shared tooltip next to the mouse (#424)
        ...
        Legend.prototype = {
            ...
            renderItem: function(item) {
                ...
                if(!li) { // generate it once, later move it
                    ...
                    item.legendItem = li = renderer.text(options.labelFormat ? format(options.labelFormat, item) : options.labelFormatter.call(item), ltr ? symbolWidth + symbolPadding : -symbolPadding, legend.baseline, useHTML).css(merge(item.visible ? itemStyle : itemHiddenStyle)) // merge to prevent modifying original (#1021)
                        .attr({
            ...
            render: function() {
                ...
                if(!legendGroup) {
                    ...
                    legend.contentGroup = renderer.g().attr({ zIndex: 1 }) // above background
                        .add(legendGroup);
        ...
        Chart.prototype = {
            ...
            showResetZoom: function() {
                ...
                this.resetZoomButton = chart.renderer.button(lang.resetZoom, null, null, function() { chart.zoomOut(); }, theme, states && states.hover).attr({
            ...
            zoom: function(event) {
                ...
                // Redraw
                if(hasZoomed) {
                    chart.redraw(pick(chart.options.chart.animation, event && event.animation, chart.pointCount < 100) // animation
                    );
                }
            },
            ...
            layOutTitles: function() {
                var titleOffset = 0, title = this.title, subtitle = this.subtitle, options = this.options, titleOptions = options.title, subtitleOptions = options.subtitle, autoWidth = this.spacingBox.width - 44; // 44 makes room for default context button
            ...
            initReflow: function() {
                ...
                function reflow(e) {
                    var width = optionsChart.width || adapterRun(renderTo, 'width'), height = optionsChart.height || adapterRun(renderTo, 'height'), target = e ? e.target : win; // #805 - MooTools doesn't supply e
        ...
        Series.prototype = {
            ...
            drawLegendSymbol: function(legend) {
                ...
                if(options.lineWidth) {
                    ...
                    this.legendLine = renderer.path([
                        M, 0, verticalCenter, L, symbolWidth, verticalCenter
             ...
             */
            getExtremes: function() {
                var xAxis = this.xAxis, yAxis = this.yAxis, stackKey = this.stackKey, stackExtremes, stackMin, stackMax, options = this.options, threshold = yAxis.isLog ? null : options.threshold, xData = this.processedXData, yData = this.processedYData, yDataLength = yData.length, activeYData = [], activeCounter = 0, xExtremes = xAxis.getExtremes(), // #2117, need to compensate for log X axis
                    xMin = xExtremes.min, xMax = xExtremes.max, validValue, withinRange, dataMin, dataMax, x, y, i, j;
            ...
            translate: function() {
                ...
                for(i = 0; i < dataLength; i++) {
                    ...
                    point.plotY = (typeof yValue === 'number' && yValue !== Infinity) ? //mathRound(yAxis.translate(yValue, 0, 1, 0, 1) * 10) / 10 : // Math.round fixes #591
                        yAxis.translate(yValue, 0, 1, 0, 1) : UNDEFINED;
            ...
            setTooltipPoints: function(renew) {
                var series = this, points = [], pointsLength, low, high, xAxis = series.xAxis, axisLength = xAxis ? (xAxis.tooltipLen || xAxis.len) : series.chart.plotSizeX, // tooltipLen and tooltipPosName used in polar
                    point, nextPoint, i, tooltipPoints = []; // a lookup array for each pixel in the x dimension
                ...
                while(i--) {
                    ...
                    if(hasPointSpecificOptions) {
                        ...
                        if(point.negative && seriesOptions.marker && negativeColor) {
                            pointAttr[NORMAL_STATE].fill = pointAttr[HOVER_STATE].fill = pointAttr[SELECT_STATE].fill = series.convertAttribs({ fillColor: negativeColor }).fill;
                        }
            ...
            alignDataLabel: function(point, dataLabel, options, alignTo, isNew) {
                var chart = this.chart, inverted = chart.inverted, plotX = pick(point.plotX, -999), plotY = pick(point.plotY, -999), bBox = dataLabel.getBBox(), alignAttr; // the final position;
            ...
            getGraphPath: function() {
                var series = this, graphPath = [], segmentPath, singlePoints = []; // used in drawTracker
            ...
            drawGraph: function() {
                ...
                ], lineWidth = options.lineWidth, dashStyle = options.dashStyle, graphPath = this.getGraphPath(), negativeColor = options.negativeColor;
            ...
            drawTracker: function() {
                ...
                if(tracker) {
                    ...
                    each([series.tracker, series.markerGroup], function(tracker) {
                        tracker.addClass(PREFIX + 'tracker').on('mouseover', onMouseOver).on('mouseout', function(e) { pointer.onTrackerMouseOut(e); }).css(css);
        ...
        var AreaSeries = extendClass(Series, {
            ...
            drawGraph: function() {
                ...
                var series = this, areaPath = this.areaPath, options = this.options, negativeColor = options.negativeColor, negativeFillColor = options.negativeFillColor, props = [
        ...
        var SplineSeries = extendClass(Series, {
            ...
            getPointSpline: function(segment, point, i) {
                ...
                if(!i) {
                    ...
                    ret = [
                        'C', lastPoint.rightContX || lastPoint.plotX, lastPoint.rightContY || lastPoint.plotY, leftContX || plotX, leftContY || plotY, plotX, plotY
                    ];
        ...
        var ColumnSeries = extendClass(Series, {
            ...
            getColumnMetrics: function() {
                ...
                if(options.grouping === false) {
                    ...
                    each(series.chart.series, function(otherSeries) {
                        ...
                        if(otherSeries.type === series.type && otherSeries.visible && yAxis.len === otherYAxis.len && yAxis.pos === otherYAxis.pos) {  // #642, #2086
                ...
                var categoryWidth = mathMin(mathAbs(xAxis.transA) * (xAxis.ordinalSlope || options.pointRange || xAxis.closestPointRange || 1), xAxis.len // #1535
            ...
            translate: function() {
                ...
                each(series.points, function(point) {
                    var plotY = mathMin(mathMax(-999, point.plotY), yAxis.len + 999), // Don't draw too far outside plot area (#1303)
                        yBottom = pick(point.yBottom, translatedThreshold), barX = point.plotX + pointXOffset, barW = seriesBarW, barY = mathMin(plotY, yBottom), right, bottom, fromTop, fromLeft, barH = mathMax(plotY, yBottom) - barY;
                ...
                if(!series._hasTracking) {
                    each(series.trackerGroups, function(key) {
                        if(series[key]) { // we don't always have dataLabelsGroup
                            series[key].addClass(PREFIX + 'tracker').on('mouseover', onMouseOver).on('mouseout', function(e) { pointer.onTrackerMouseOut(e); }).css(css);
                            if(hasTouch) {
            ...
            alignDataLabel: function(point, dataLabel, options, alignTo, isNew) {
                var chart = this.chart, inverted = chart.inverted, dlBox = point.dlBox || point.shapeArgs, // data label box for alignment
                    below = point.below || (point.plotY > pick(this.translatedThreshold, chart.plotSizeY)), inside = pick(options.inside, !!this.options.stacking); // draw it inside the box?
        ...
        var PieSeries = {
            ...
            translate: function(positions) {
                ...
                for(i = 0; i < len; i++) {
                    ...
                    point.tooltipPos = [
                        positions[0] + radiusX * 0.7, positions[1] + radiusY * 0.7
                    ];
