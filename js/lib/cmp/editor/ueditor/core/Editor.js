...
define(function(require, exports, module) {
    ...
    require('./node'); // 注入UE.htmlparser和UE.uNode
    var ie = browser.ie;
    // plugins/serialize.js 无此文件，本文件相关plugins/serialize.js的代码处于注释中
    ...
    (function () {
        ...
        var Editor = UE.Editor = function (options) {
            ...
            EventBase.call(me);
            me.commands = {};
            me.options = utils.extend(utils.clone(options || {}), null, true); // UEDITOR_CONFIG -> null，修改
            me.shortcutkeys = {};
            me.inputRules = [];
            me.outputRules = [];
            //设置默认的常用属性
            me.setOpt({
                ...
                // iframeCssUrl: me.options.UEDITOR_HOME_URL + 'themes/iframe.css', // 修改-> 使用seajs加载
