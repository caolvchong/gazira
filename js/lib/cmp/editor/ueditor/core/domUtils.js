...
define(function(require, exports, module) {
    ...
    var attrFix = ie && browser.version < 9 ? {
            ...
            '-webkit-box', '-moz-box', 'block' , 'list-item' , 'table' , 'table-row-group' , 'table-header-group', 'table-footer-group' , 'table-row' , 'table-column-group' , 'table-column' , 'table-cell' , 'table-caption'
        ]);
    ...
    domUtils.getDomNode = getDomNode; // 增加：getDomNode对外接口
