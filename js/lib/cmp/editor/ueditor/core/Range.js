            ...
            try {
                if(fillData && domUtils.inDoc(fillData, doc)) {
                    if(!fillData.nodeValue.replace(fillCharReg, '').length) {
                        ...
                        while(tmpNode && domUtils.isEmptyInlineElement(tmpNode) && //safari的contains有bug
        ...
        Range.prototype = {
            ...
            createAddress: function(ignoreEnd, ignoreTxt) {
                ...
                function getAddress(isStart) {
                    ...
                    var parents = domUtils.findParents(node, true, function(node) {return !domUtils.isBody(node)}), addrs = [];
